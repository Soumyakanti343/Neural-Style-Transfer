...
def parse_arguments() :
    ...
    parser.add_argument('--content_dir', type = str, default = 'C:/Users/upadh/OneDrive/Desktop/Neural Style Transfer/content_data', help = 'Location of content dataset')
    parser.add_argument('--style_dir', type = str, default = 'C:/Users/upadh/OneDrive/Desktop/Neural Style Transfer/style_data', help = 'Loaction of style dataset')
    parser.add_argument('--vgg', type = str, default = 'C:/Users/upadh/OneDrive/Desktop/Neural Style Transfer/vgg_normalised.pth', help = 'Location of pre-trained VGG')
